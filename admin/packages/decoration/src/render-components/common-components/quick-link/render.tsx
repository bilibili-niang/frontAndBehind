...
import { useAction, ActionItem, uuid } from '@pkg/core'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(() => {
      try {
        const target =
          (document.querySelector('.deck-editor-render__viewport') as Element | null) ||
          (rootRef.value as Element | null) ||
    ...
    return () => {
      if (isSwipe.value) {
        return (
          <div class="c_quick-link" key={swipeKey.value} ref={rootRef}>
            <div
      ...
      return (
        <div class={['c_quick-link', scrollAble.value && 'c_quick-link--scrollable']} ref={rootRef}>
