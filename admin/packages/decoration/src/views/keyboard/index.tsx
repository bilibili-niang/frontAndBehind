              ...
              <g>
                <g data-key="meta">
                  <rect
                    ...
                    rx="3"
                  ></rect>
                  <path d="M78.766 193.5H74.5V197.766H78.766V193.5Z" fill="white"></path>
                  <path d="M83.5 193.5H79.234V197.766H83.5V193.5Z" fill="white"></path>
                  <path d="M78.766 198.234H74.5V202.5H78.766V198.234Z" fill="white"></path>
                  <path d="M83.5 198.234H79.234V202.5H83.5V198.234Z" fill="white"></path>
                  <rect
                    x="57.25"
                    y="179.25"
                    width="43.5"
