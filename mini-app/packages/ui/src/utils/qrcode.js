...
function drawQrcode(options) {
  ...
  function createCanvas() {
    ...
    if (options.ctx) {
      ...
      ctx = options._this
        ? currentPlatform.createCanvasContext && currentPlatform.createCanvasContext(options.canvasId, options._this)
        : currentPlatform.createCanvasContext && currentPlatform.createCanvasContext(options.canvasId)
    }
